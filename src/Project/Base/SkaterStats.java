...
public class SkaterStats extends Stats
{
    ...
    public SkaterStats(String check, String fight, String Dis, String skate, String strength, String endurance, String puck, String face, String pass, String score, String defence, String penalty){
